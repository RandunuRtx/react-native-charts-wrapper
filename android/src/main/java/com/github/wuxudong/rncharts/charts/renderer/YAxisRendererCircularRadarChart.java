...
public class YAxisRendererCircularRadarChart extends YAxisRenderer {

    private CircularRadarChart mChart;

    public YAxisRendererCircularRadarChart(ViewPortHandler viewPortHandler, YAxis yAxis, CircularRadarChart chart) {
