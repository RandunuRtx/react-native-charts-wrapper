...
public class CircularRadarChart extends PieRadarChartBase<RadarData> {
    ...
    protected YAxisRendererCircularRadarChart mYAxisRenderer;
    protected XAxisRendererCircularRadarChart mXAxisRenderer;

    public CircularRadarChart(Context context) {
        super(context);
    }

    public CircularRadarChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircularRadarChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new CircularRadarChartRenderer(this, mAnimator, mViewPortHandler);
        mYAxisRenderer = new YAxisRendererCircularRadarChart(mViewPortHandler, mYAxis, this);
        mXAxisRenderer = new XAxisRendererCircularRadarChart(mViewPortHandler, mXAxis, this);
