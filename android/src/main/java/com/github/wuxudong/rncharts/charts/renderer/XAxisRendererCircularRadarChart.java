...
public class XAxisRendererCircularRadarChart extends XAxisRenderer {

    private CircularRadarChart mChart;

    public XAxisRendererCircularRadarChart(ViewPortHandler viewPortHandler, XAxis xAxis, CircularRadarChart chart) {
