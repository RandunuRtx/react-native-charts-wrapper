...
import com.github.wuxudong.rncharts.charts.renderer.CircularRadarArcChartRenderer;
import com.github.wuxudong.rncharts.charts.renderer.CircularRadarChartRenderer;
import com.github.wuxudong.rncharts.charts.renderer.XAxisRendererCircularArcRadarChart;
import com.github.wuxudong.rncharts.charts.renderer.XAxisRendererCircularRadarChart;
import com.github.wuxudong.rncharts.charts.renderer.YAxisRendererCircularArcRadarChart;
import com.github.wuxudong.rncharts.charts.renderer.YAxisRendererCircularRadarChart;

public class CircularRadarArcChart extends PieRadarChartBase<RadarData> {
    ...
    protected YAxisRendererCircularArcRadarChart mYAxisRenderer;
    protected XAxisRendererCircularArcRadarChart mXAxisRenderer;

    public CircularRadarArcChart(Context context) {
        super(context);
    }

    public CircularRadarArcChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircularRadarArcChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new CircularRadarArcChartRenderer(this, mAnimator, mViewPortHandler);
        mYAxisRenderer = new YAxisRendererCircularArcRadarChart(mViewPortHandler, mYAxis, this);
        mXAxisRenderer = new XAxisRendererCircularArcRadarChart(mViewPortHandler, mXAxis, this);
