...
public class YAxisRendererCircularArcRadarChart extends YAxisRenderer {

    private CircularRadarArcChart mChart;

    public YAxisRendererCircularArcRadarChart(ViewPortHandler viewPortHandler, YAxis yAxis, CircularRadarArcChart chart) {
