...
public class XAxisRendererCircularArcRadarChart extends XAxisRenderer {

    private CircularRadarArcChart mChart;

    public XAxisRendererCircularArcRadarChart(ViewPortHandler viewPortHandler, XAxis xAxis, CircularRadarArcChart chart) {
