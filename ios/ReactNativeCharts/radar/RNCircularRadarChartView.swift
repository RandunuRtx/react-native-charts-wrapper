...
class RNCircularRadarChartView: RNYAxisChartViewBase {

    let _chart: CircularRadarChartView;
    let _dataExtract : RadarDataExtract

    override var chart: CircularRadarChartView {
        return _chart
    }
    ...
    override init(frame: CoreGraphics.CGRect) {
        ...
        self._chart = CircularRadarChartView(frame: frame)
