...
class RNCircularRadarArcChartView: RNYAxisChartViewBase {

    let _chart: CircularRadarArcChartView;
    let _dataExtract : RadarDataExtract

    override var chart: CircularRadarArcChartView {
        return _chart
    }
    ...
    override init(frame: CoreGraphics.CGRect) {
        ...
        self._chart = CircularRadarArcChartView(frame: frame)
